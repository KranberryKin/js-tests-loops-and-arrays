...
function flightCost(destination, firstClass) {
    ...
    let x = flights.find(f => f.to.toLowerCase() == destination.toLowerCase());
        if(firstClass){
...
let x = theBand.members.find(f => f.name.includes(name))
return x.name + ' ' + 'is in the band and plays the' + ' ' + x.instrument
}
